...
ACLOCAL = ${SHELL} /sources/kannel/missing aclocal-1.15
AUTOCONF = ${SHELL} /sources/kannel/missing autoconf
AUTOHEADER = ${SHELL} /sources/kannel/missing autoheader
...
POST_UNINSTALL = :
CC = gcc -std=gnu99
MAKEINFO = ${SHELL} /sources/kannel/missing makeinfo
PACKAGE = Kannel
RANLIB = ranlib
SHELL = /bin/sh
VERSION = svn-r5239M
...
LIBS=-lmysqlclient_r -lssl -lrt -lresolv -lnsl -lm  -lpthread -lxml2 -lz -lm -ldl -L/usr/lib/gcc/x86_64-redhat-linux/4.8.5/../../../../lib64 -lcrypto -lssl -L/usr/lib64  -lmysqlclient -lpthread -lz -lm -ldl -lssl -lcrypto 
CFLAGS=-D_REENTRANT=1 -I. -Igw -g -O2 -D_XOPEN_SOURCE=600 -D_BSD_SOURCE -D_DEFAULT_SOURCE -D_LARGE_FILES= -I/usr/include/libxml2 -I/usr/local/ssl/include -I/usr/include/mysql
LDFLAGS= -rdynamic
...
gw-config: utils/foobar-config.sh Makefile
	./utils/foobar-config.sh "-I$(includedir)/kannel -g -O2 -D_XOPEN_SOURCE=600 -D_BSD_SOURCE -D_DEFAULT_SOURCE -D_LARGE_FILES= -I/usr/include/libxml2 -I/usr/local/ssl/include -I/usr/include/mysql" \
		"-L$(libdir)/kannel -lgw -lwap -lgwlib $(LIBS)" \
		"svn-r5239M" > gw-config
